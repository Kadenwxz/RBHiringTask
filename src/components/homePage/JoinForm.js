            ...
            <div className="join-form-body">
                <div className="container join_form_subbody">
                    ...
                    <form className="join-form">
                        <input type="text" className="join-email" placeholder="Email" autoComplete="off" required/>
                        <input type="password" className="join-password" placeholder="Password" autoComplete="off" required/>
